...
//                System.out.println("twice");
    ...
    /**
     * 判断类型,不可消返回0，无拐点返回1，一个拐点返回2，两个拐点返回3
     */
    public int judgetype(Lattice.Point point1, Lattice.Point point2, boolean changePath) {
        this.path = new Path(point1);
        int x1 = point1.x, y1 = point1.y;
        int x2 = point2.x, y2 = point2.y;
        if (lattices[y1][x1] == null || lattices[y2][x2] == null) {
...
//                System.out.println("twice");
    ...
    public int judgetype(Lattice.Point point1, Lattice.Point point2) {
    	return judgetype(point1, point2, true);
    }
    /**
     * 判断指定坐标的格子是否为空
     */

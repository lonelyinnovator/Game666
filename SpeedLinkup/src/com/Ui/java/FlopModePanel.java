...
public class FlopModePanel extends JPanel implements MouseListener, MouseMotionListener{
    ...
    private int minute;
    private int second;
    private int timeincreasenumber = 0;
    ...
    public FlopModePanel(FlopModeFrame flopModeFrame, FlopArchive flopArchive) {
    	super();
        initMainPanel(flopModeFrame,flopArchive);
    }

    public void initMainPanel(FlopModeFrame flopModeFrame, FlopArchive flopArchive) {
    ...
    private void removeLatticeImg() {
        try {
            ...
            if (point1.x < 0 || point1.y < 0 || point2.x < 0 || point2.y < 0
                    || point1.x > map_size_x || point1.y > map_size_y
                    || point2.x > map_size_x || point2.y > map_size_y) {
                return;
            }
            if (map.judge(point1, point2)) {
                ...
                g.fillRect(changeLocation(point1)[0], changeLocation(point1)[1],
                        picture_width + 1, picture_height + 1);
                g.fillRect(changeLocation(point2)[0], changeLocation(point2)[1],
                        picture_width + 1, picture_height + 1);

...
public class TypicalModeFrame extends JFrame {
    ...
    private void initTypicalModeFrame() {
        ...
        jLabel_easy.addMouseListener(new MouseListener() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                if (change_difficulty_flag) {
                    ...
                    initTypicalArchive(typicalArchive);
                    typicalModePanel.initTypicalModePanel(typicalModeFrame, typicalArchive);
        ...
        jLabel_time_remain = new JLabel(typicalModePanel.minute + ":" + typicalModePanel.second);
    ...
    private void showCountDown() {
        ...
        new Thread(() -> {
            while (typicalModePanel.time > 0) {
                ...
                try {
                    typicalModePanel.minute = typicalModePanel.time / 60 % 60;
                    typicalModePanel.second = typicalModePanel.time % 60;
                    countDown = typicalModePanel.minute + ":" + typicalModePanel.second;
                    Thread.sleep(1000);
                    jLabel_time_remain.setFont(f);
                    jLabel_time_remain.setText(countDown);
                    TypicalArchive.saveArchiveInfo(typicalModePanel.map, typicalModePanel.model, typicalModePanel.theme,
                            typicalModePanel.hour, typicalModePanel.minute, typicalModePanel.second);
